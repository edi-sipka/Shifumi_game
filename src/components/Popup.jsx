...
<div class="relative flex justify-center items-center z-10">
  ...
  <Animations />
    <div class="2xl:container  2xl:mx-auto py-48 px-4 md:px-28 flex justify-center items-center">
      <div class="w-96 md:w-auto dark:bg-gray-800 relative flex flex-col justify-center items-center bg-gray py-16 px-4 md:px-24 xl:py-24 xl:px-36">
        <div role="banner">
   <img src='https://img.itch.zone/aW1nLzY3MjIwODYucG5n/original/ikx0H9.png'/>
        </div>
        <div class="mt-12">
          <h1 role="main" class="text-3xl dark:text-white lg:text-6xl font-semibold leading-7 lg:leading-9 text-center"> {finalScore}  </h1>
        </div>
        <div class="mt-4">
